...
@section('content')
    <div class="mx-auto">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 font-serif">Tambah Buku Baru</h1>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" id="bookForm">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Sampul Buku (Thumbnail)</label>
                        <div class="flex flex-col md:flex-row gap-4 items-center">
                            <div id="preview-container"
                                class="hidden w-32 h-44 rounded-xl border-2 border-[#0f392b] border-dashed overflow-hidden bg-gray-50 flex-shrink-0">
                            ...
                            <div class="flex-grow w-full">
                                <label for="thumbnail"
                                    ...
                                    <div class="text-center p-4" id="upload-placeholder">
                                        ...
                                        <p class="text-sm text-gray-500 font-semibold">Klik untuk pilih sampul</p>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                            ...
                            placeholder="Tulis sinopsis atau deskripsi singkat buku ini...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
